                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-stretch">
                    ...
                    <div className="flex flex-col justify-center space-y-8" data-aos="fade-right">
                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-black uppercase leading-tight tracking-tight">
                            VOCÊ PODE CONTINUAR TENTANDO AJUSTAR <span className="text-gray-500">SOZINHO</span>, INVESTIR EM <span className="text-gray-500">EQUIPE</span> E TESTAR CAMINHOS POR MAIS <span className="text-gray-500">ALGUNS MESES</span>.
                        </h2>
                    ...
                    <div className="bg-[#111111] p-8 md:p-12 rounded-2xl border border-gray-800" data-aos="fade-left">
                        ...
                        <ul className="space-y-6 text-gray-300 text-lg">
                            ...
                            <li className="flex items-start">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <ul className="pl-4 space-y-2 border-l border-gray-700 ml-1">
